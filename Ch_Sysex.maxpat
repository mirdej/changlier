...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 392.278564, 345.0, 32.0, 22.0 ],
					"style" : "",
					"text" : "* 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 114.278564, 354.0, 39.0, 22.0 ],
					"style" : "",
					"text" : "* 500"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 551.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 629.0, 135.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 320.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.528564, 584.0, 183.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 109.528564, 527.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "* 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 109.528564, 499.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.278564, 320.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "#1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 27.528564, 498.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.528564, 584.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "set -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 27.528564, 527.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "delay 2030"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.528564, 472.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "r device"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.028564, 617.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "r device"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.028564, 617.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "midiout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 27.528564, 553.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 487.5, 311.0, 123.778564, 311.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 204.028564, 624.5, 421.5, 624.5 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 513.5, 469.0, 154.171417, 469.0 ],
					"order" : 2,
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 513.5, 450.5, 401.778564, 450.5 ],
					"order" : 1,
					"source" : [ "obj-86", 0 ]
				}
